...
('all_parameters', ctypes.c_double * 100),
('ToleranceInequalities', ctypes.c_double),
('ToleranceEqualities', ctypes.c_double),
...
'ToleranceInequalities' : np.array([]),
'ToleranceEqualities' : np.array([]),
...
'ToleranceInequalities' : np.float64,
'ToleranceEqualities' : np.float64,
