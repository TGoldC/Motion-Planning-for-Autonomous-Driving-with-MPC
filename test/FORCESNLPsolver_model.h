...
casadi_int FORCESNLPsolver_dobjective_0_n_out(void);
casadi_int FORCESNLPsolver_dobjective_0_n_in(void);
...
casadi_int FORCESNLPsolver_ddynamics_0_n_out(void);
casadi_int FORCESNLPsolver_ddynamics_0_n_in(void);
...
casadi_int FORCESNLPsolver_dobjective_1_n_out(void);
casadi_int FORCESNLPsolver_dobjective_1_n_in(void);
